...
export function getUtxoDust(addressType) {
  if (addressType === AddressType.P2TR || addressType === AddressType.M44_P2TR || addressType === AddressType.P2WPKH || addressType === AddressType.M44_P2WPKH) {
    return 330;
  } else {
    return 546;
  }
}
export function getAddressUtxoDust(address) {
